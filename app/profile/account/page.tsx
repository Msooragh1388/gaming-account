...
export default function AccountPage() {
  ...
  // نام و نام خانوادگی در یک کادر واقعی
  ...
  async function loadProfile() {
    ...
    try {
      ...
      // اطلاعات قبلی را داخل همان یک کادر قرار می‌دهیم
      setFullName(
  ...
  async function saveProfile() {
    ...
    // فقط هنگام ذخیره جدا می‌شود.
    // هنگام تایپ کاربر هیچ split یا تغییری روی متن انجام نمی‌شود.
